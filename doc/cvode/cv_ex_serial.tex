...
\subsection{A dense example: cv_roberts\_dns}\label{ss:cvRoberts}
...
%%
\includeOutput{cv_roberts\_dns}{../../examples/cvode/cvRoberts/c/cv_roberts_dns.out}
%%

%-------------------------------------------------------------------------------

\subsection{A banded example: cv_adv_diff\_bnd}\label{ss:cvAdvDiff}
...
%%
\includeOutput{cv_adv_diff\_bnd}{../../examples/cvode/cvAdvDiff/c/cv_adv_diff_bnd.out}
%%

%-------------------------------------------------------------------------------

\subsection{A Krylov example: cv_diurnal\_kry}\label{ss:cvDiurnal}
...
%%
\includeOutput{cv_diurnal\_dns}{../../examples/cvode/cvDiurnal/c/cv_diurnal_kry.out}
%%
