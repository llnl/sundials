...
%%
\includeOutput{cvRoberts\_dns}{../../examples/cvode/cvRoberts/c/cvRoberts_dns.out}
%%
...
%%
\includeOutput{cvAdvDiff\_bnd}{../../examples/cvode/cvAdvDiff/c/cvAdvDiff_bnd.out}
%%
...
%%
\includeOutput{cvDiurnal\_dns}{../../examples/cvode/cvDiurnal/c/cvDiurnal_kry.out}
%%
