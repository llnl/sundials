...
The stiff example problem \id{cv_diurnal\_kry} described above, or rather its parallel
version \id{cv_diurnal\_kry\_p}, has been modified and expanded to form a test problem for
...
Eq. (\ref{cv_diurnalic}) has been replaced by:
\begin{equation}
