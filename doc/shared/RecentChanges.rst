...
SPRKStep stepper, and LSRKStep's use of the automated dominant eigenvalue estimation
module.  The default number of stages for the SSP Runge-Kutta methods
