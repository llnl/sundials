# SUNDIALS Governance (Draft)

SUNDIALS is led in an open governance model, described in this document.

> This is a draft adapted from the AMReX governance model and should be revised by the SUNDIALS team.
...
Decisions of the SC usually happen in developer meetings, via e-mail, or public chat.
...
Discussion in the TC usually happens in developer meetings. Developer meetings can be scheduled by any member of the SC or TC.
...
Decisions are documented in developer meeting notes and/or in the GitHub repository.
...
TC members are maintainers of SUNDIALS.
...
Contributors are valuable, vetted developers of SUNDIALS.
Contributions can be in many forms and not all need to be code contributions.
Examples include code pull requests, support in issues and user discussions, writing and updating documentation, writing tutorials, visualizations, R&D on algorithms, testing and benchmarking, etc.
Contributors can participate in developer meetings and weigh in on discussions.
Contributors can triage (i.e., add and remove labels on) pull requests, issues, and GitHub discussion pages.
...
Appointed after contributing to SUNDIALS (see above) through nomination by any member of the TC. Another member of the TC must second the nomination.
...
Former contributors do not play any role in the governance of SUNDIALS.
Instead, former (e.g., inactive) contributors are acknowledged separately in GitHub contributor tracking, SUNDIALS documentation, references, etc. as appropriate.

Former members of SC, TC, and Contributors are not kept on the roster, since committee role rosters should reflect currently active members and the responsible governance body. Former members of the SC or TC also do not play any role in the governance of SUNDIALS.
