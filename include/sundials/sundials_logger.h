...
SUNDIALS_EXPORT
SUNErrCode SUNLogger_GetErrorFile(SUNLogger logger, FILE** error_fp); // nb::rv_policy::reference
...
SUNDIALS_EXPORT
SUNErrCode SUNLogger_GetWarningFile(SUNLogger logger, FILE** warning_fp); // nb::rv_policy::reference
...
SUNDIALS_EXPORT
SUNErrCode SUNLogger_GetDebugFile(SUNLogger logger, FILE** debug_fp); // nb::rv_policy::reference
...
SUNDIALS_EXPORT
SUNErrCode SUNLogger_GetInfoFile(SUNLogger logger, FILE** info_fp); // nb::rv_policy::reference
