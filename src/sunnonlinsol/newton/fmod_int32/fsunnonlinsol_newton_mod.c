...
SWIGEXPORT int _wrap_FSUNNonlinSolGetDeltaNorm_Newton(SUNNonlinearSolver farg1, double *farg2) {
  int fresult ;
  SUNNonlinearSolver arg1 = (SUNNonlinearSolver) 0 ;
  ...
  result = (SUNErrCode)SUNNonlinSolGetDeltaNorm_Newton(arg1,arg2);
  fresult = (SUNErrCode)(result);
  return fresult;
}
