...
module fnvector_manyvector_mod
 ...
 public :: FN_VDotProdComplex_ManyVector
...
function swigc_FN_VDotProdComplex_ManyVector(farg1, farg2, farg3) &
bind(C, name="_wrap_FN_VDotProdComplex_ManyVector") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
type(C_PTR), value :: farg1
type(C_PTR), value :: farg2
...
function FN_VDotProdComplex_ManyVector(x, y, result) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(N_Vector), target, intent(inout) :: x
...
fresult = swigc_FN_VDotProdComplex_ManyVector(farg1, farg2, farg3)
swig_result = fresult
end function
