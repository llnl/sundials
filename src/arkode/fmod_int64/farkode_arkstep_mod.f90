...
module farkode_arkstep_mod
 ...
 integer(C_INT), parameter, public :: ARKSTEP_DEFAULT_DIRK_2 = ARKODE_GKC21_DIRK_3_1_2
 ...
 integer(C_INT), parameter, public :: ARKSTEP_DEFAULT_ARK_ITABLE_2 = ARKODE_GKC21_DIRK_3_1_2
