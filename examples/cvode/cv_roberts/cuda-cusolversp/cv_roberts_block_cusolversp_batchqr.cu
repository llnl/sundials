 ...
 * cv_roberts_klu.c. We simulate a scenario where a set of independent
 ...
 *
 *    ./cv_roberts_block_cusolversp_batchqr [number of groups]
 *
 * This problem is comparable to the cv_roberts_block_klu.c example.
 * ------------------------------------------------------------------*/
