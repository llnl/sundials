...
# -----------------------------------------------------------------------------
# matplotlib-based plotting script for cv_pendulum_dns.c example
# -----------------------------------------------------------------------------
...
parser = argparse.ArgumentParser(description="Plots cv_pendulum_dns output")
...
ref = np.loadtxt("cv_pendulum_dns_ref.txt", dtype=np.double)
