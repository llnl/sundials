...
parser.add_argument(
    "--sfile", type=str, default="cv_particle_solution.txt", help="solution output file to read"
)
parser.add_argument(
    "--efile", type=str, default="cv_particle_error.txt", help="error output file to read"
)
parser.add_argument(
