...
int main(int argc, char* argv[])
{
  ...
  cout << setw(22) << tret << setw(25) << SUN_REAL(ydata[0]) << setw(25) << SUN_REAL(ydata[1])
       << setw(25) << abs(SUN_REAL(ydata[0]) - utrue) << setw(25) << abs(SUN_REAL(ydata[1]) - vtrue)
       << endl;
#endif
...
#elif defined(SUNDIALS_SCALAR_TYPE_COMPLEX)
    cout << setw(22) << tret << setw(25) << SUN_REAL(ydata[0]) << setw(25) << SUN_REAL(ydata[1])
         << setw(25) << abs(SUN_REAL(ydata[0]) - utrue) << setw(25)
         << abs(SUN_REAL(ydata[1]) - vtrue) << endl;
#endif
