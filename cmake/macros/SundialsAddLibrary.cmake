...
macro(sundials_add_library target)
  ...
  foreach(_libtype ${_libtypes})
    ...
    if(${_libtype} MATCHES "STATIC")
      ...
      set(_oppo_lib_suffix "${_SHARED_LIB_SUFFIX}")
    else()
      set(_lib_suffix "${_SHARED_LIB_SUFFIX}")
      set(_oppo_lib_suffix "${_STATIC_LIB_SUFFIX}")
    endif()
    ...
    if(NOT sundials_add_library_OBJECT_LIB_ONLY)
      ...
      if(sundials_add_library_LINK_LIBRARIES)
        ...
        dealias_libraries(
          ...
          dealiased_sundials_add_library_LINK_LIBRARIES ${_lib_suffix} ${_oppo_lib_suffix})
        target_link_libraries(${_actual_target_name}
...
macro(dealias_libraries libs_in libs_out lib_suffix oppo_lib_suffix)
  set(${libs_out} "")
  foreach(_lib ${${libs_in}})
    if(TARGET ${_lib})
      get_target_property(aliased_target_name ${_lib} ALIASED_TARGET)
      if(aliased_target_name MATCHES ${lib_suffix})
        list(APPEND ${libs_out} ${aliased_target_name})
      elseif(aliased_target_name MATCHES ${oppo_lib_suffix})
        list(APPEND ${libs_out} ${_lib}${lib_suffix})
      else()
        list(APPEND ${libs_out} ${_lib})
      endif()
    else()
      # handle visibility modifiers PUBLIC, PRIVATE etc.
      list(APPEND ${libs_out} ${_lib})
    endif()
  endforeach()
endmacro()
