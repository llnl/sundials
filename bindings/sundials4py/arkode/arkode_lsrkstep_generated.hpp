...
auto pyEnumARKODE_LSRKMethodType =
    nb::enum_<ARKODE_LSRKMethodType>(m, "ARKODE_LSRKMethodType", nb::is_arithmetic(), "")
...
m.def("LSRKStepSetDomEigEstimator",
    LSRKStepSetDomEigEstimator, nb::arg("arkode_mem"), nb::arg("DEE"));
...
m.def("LSRKStepSetUseAnalyticStabRegion",
    LSRKStepSetUseAnalyticStabRegion, nb::arg("arkode_mem"), nb::arg("analytic_stab_region"));

m.def("LSRKStepSetNumDomEigEstInitPreprocessIters",
    LSRKStepSetNumDomEigEstInitPreprocessIters, nb::arg("arkode_mem"), nb::arg("num_iters"));

m.def("LSRKStepSetNumDomEigEstPreprocessIters",
    LSRKStepSetNumDomEigEstPreprocessIters, nb::arg("arkode_mem"), nb::arg("num_iters"));
...
m.def("LSRKStepGetNumDomEigUpdates",
    ...
    {
        auto LSRKStepGetNumDomEigUpdates_adapt_modifiable_immutable_to_return = [](void * arkode_mem) -> std::tuple<int, long>
        {
...
m.def("LSRKStepGetMaxNumStages",
    ...
    {
        auto LSRKStepGetMaxNumStages_adapt_modifiable_immutable_to_return = [](void * arkode_mem) -> std::tuple<int, int>
        {
...
m.def("LSRKStepGetNumDomEigEstRhsEvals",
    [](void * arkode_mem) -> std::tuple<int, long>
    {
        auto LSRKStepGetNumDomEigEstRhsEvals_adapt_modifiable_immutable_to_return = [](void * arkode_mem) -> std::tuple<int, long>
        {
...
m.def("LSRKStepGetNumDomEigEstIters",
    [](void * arkode_mem) -> std::tuple<int, long>
    {
        auto LSRKStepGetNumDomEigEstIters_adapt_modifiable_immutable_to_return = [](void * arkode_mem) -> std::tuple<int, long>
        {
            long num_iters_adapt_modifiable;

            int r = LSRKStepGetNumDomEigEstIters(arkode_mem, &num_iters_adapt_modifiable);
