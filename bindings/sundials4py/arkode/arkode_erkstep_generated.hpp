...
m.def("ERKStepGetCurrentButcherTable",
    [](void * arkode_mem) -> std::tuple<int, ARKodeButcherTable>
    {
        auto ERKStepGetCurrentButcherTable_adapt_modifiable_immutable_to_return = [](void * arkode_mem) -> std::tuple<int, ARKodeButcherTable>
        {
...
m.def("ERKStepGetTimestepperStats",
    ...
    {
        auto ERKStepGetTimestepperStats_adapt_modifiable_immutable_to_return = [](void * arkode_mem) -> std::tuple<int, long, long, long, long, long>
        {
            ...
            return std::make_tuple(r, expsteps_adapt_modifiable, accsteps_adapt_modifiable, step_attempts_adapt_modifiable, nfevals_adapt_modifiable, netfails_adapt_modifiable);
        };
