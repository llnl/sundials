...
#include "arkode_generated.hpp"
  ...
  BIND_ARKODE_CALLBACK(ARKodeSetPreStepFn, ARKPreStepFn,
                       prestepfn, arkode_prestepfn_wrapper,
                       nb::arg("arkode_mem"), nb::arg("prestep").none());

  BIND_ARKODE_CALLBACK(ARKodeSetPostStepFn, ARKPostStepFn,
                       poststepfn, arkode_poststepfn_wrapper,
                       nb::arg("arkode_mem"), nb::arg("poststep").none());

  BIND_ARKODE_CALLBACK(ARKodeSetPreRhsFn, ARKPreRhsFn,
                       prerhsfn, arkode_prerhsfn_wrapper,
                       nb::arg("arkode_mem"), nb::arg("prerhs").none());
