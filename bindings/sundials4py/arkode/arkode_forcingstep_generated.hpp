...
m.def("ForcingStepGetNumEvolves",
    ...
    {
        auto ForcingStepGetNumEvolves_adapt_modifiable_immutable_to_return = [](void * arkode_mem, int partition) -> std::tuple<int, long>
        {
        ...
        return ForcingStepGetNumEvolves_adapt_modifiable_immutable_to_return(arkode_mem, partition);
