...
auto pyEnumARKODE_MRITableID =
    nb::enum_<ARKODE_MRITableID>(m, "ARKODE_MRITableID", nb::is_arithmetic(), "MRI coupling table IDs")
        ...
        .value("ARKODE_MRI_GARK_IMPLICIT_MIDPOINT", ARKODE_MRI_GARK_IMPLICIT_MIDPOINT, "")
...
m.def("MRIStepCoupling_LoadTable",
    [](ARKODE_MRITableID method) -> std::shared_ptr<std::remove_pointer_t<MRIStepCoupling>>
    {
        auto MRIStepCoupling_LoadTable_adapt_return_type_to_shared_ptr = [](ARKODE_MRITableID method) -> std::shared_ptr<std::remove_pointer_t<MRIStepCoupling>>
        {
            auto lambda_result = MRIStepCoupling_LoadTable(method);

            return our_make_shared<std::remove_pointer_t<MRIStepCoupling>, MRIStepCouplingDeleter>(lambda_result);
...
m.def("MRIStepCoupling_LoadTableByName",
    ...
    {
        auto MRIStepCoupling_LoadTableByName_adapt_return_type_to_shared_ptr = [](const char * method) -> std::shared_ptr<std::remove_pointer_t<MRIStepCoupling>>
        {
...
m.def("MRIStepCoupling_Create",
    [](int nmat, int stages, int q, int p, sundials4py::Array1d W_1d, sundials4py::Array1d G_1d, sundials4py::Array1d c_1d) -> std::shared_ptr<std::remove_pointer_t<MRIStepCoupling>>
    {
        auto MRIStepCoupling_Create_adapt_arr_ptr_to_std_vector = [](int nmat, int stages, int q, int p, sundials4py::Array1d W_1d, sundials4py::Array1d G_1d, sundials4py::Array1d c_1d) -> MRIStepCoupling
        {
            ...
            auto lambda_result = MRIStepCoupling_Create(nmat, stages, q, p, W_1d_ptr, G_1d_ptr, c_1d_ptr);
            return lambda_result;
        };
        auto MRIStepCoupling_Create_adapt_return_type_to_shared_ptr = [&MRIStepCoupling_Create_adapt_arr_ptr_to_std_vector](int nmat, int stages, int q, int p, sundials4py::Array1d W_1d, sundials4py::Array1d G_1d, sundials4py::Array1d c_1d) -> std::shared_ptr<std::remove_pointer_t<MRIStepCoupling>>
        {
            auto lambda_result = MRIStepCoupling_Create_adapt_arr_ptr_to_std_vector(nmat, stages, q, p, W_1d, G_1d, c_1d);

            return our_make_shared<std::remove_pointer_t<MRIStepCoupling>, MRIStepCouplingDeleter>(lambda_result);
            return lambda_result;
        };

        return MRIStepCoupling_Create_adapt_return_type_to_shared_ptr(nmat, stages, q, p, W_1d, G_1d, c_1d);
    },     nb::arg("nmat"), nb::arg("stages"), nb::arg("q"), nb::arg("p"), nb::arg("W_1d"), nb::arg("G_1d"), nb::arg("c_1d"));

m.def("MRIStepCoupling_MIStoMRI",
    [](ARKodeButcherTable B, int q, int p) -> std::shared_ptr<std::remove_pointer_t<MRIStepCoupling>>
    {
        auto MRIStepCoupling_MIStoMRI_adapt_return_type_to_shared_ptr = [](ARKodeButcherTable B, int q, int p) -> std::shared_ptr<std::remove_pointer_t<MRIStepCoupling>>
        {
...
m.def("MRIStepCoupling_Copy",
    ...
    {
        auto MRIStepCoupling_Copy_adapt_return_type_to_shared_ptr = [](MRIStepCoupling MRIC) -> std::shared_ptr<std::remove_pointer_t<MRIStepCoupling>>
        {
...
m.def("MRIStepGetCurrentCoupling",
    [](void * arkode_mem) -> std::tuple<int, MRIStepCoupling>
    {
        auto MRIStepGetCurrentCoupling_adapt_modifiable_immutable_to_return = [](void * arkode_mem) -> std::tuple<int, MRIStepCoupling>
        {
...
m.def("MRIStepGetLastInnerStepFlag",
    ...
    {
        auto MRIStepGetLastInnerStepFlag_adapt_modifiable_immutable_to_return = [](void * arkode_mem) -> std::tuple<int, int>
        {
...
m.def("MRIStepGetNumInnerStepperFails",
    ...
    {
        auto MRIStepGetNumInnerStepperFails_adapt_modifiable_immutable_to_return = [](void * arkode_mem) -> std::tuple<int, long>
        {
